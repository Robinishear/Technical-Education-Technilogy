...
const API_URL = `${process.env.NEXT_PUBLIC_API_BASE_URL}/testimonials`;

// API functions
const fetchtestimonials = async (): Promise<Instructor[]> => {
...
const InstructorManagement: React.FC = () => {
  ...
  return (
    <div className="p-8 shadow-sm rounded-2xl min-h-screen text-white">
      <h1 className="text-3xl font-bold mb-8 text-cyan-400">                Testimonial Hub
</h1>
  ...
  <div className="flex gap-4">
    ...
    {isEditing && (
      ...
      {/* Table */}
      {isLoading ? (
        <p className="text-center text-cyan-400 animate-pulse">Loading testimonials...</p>
      ) : isError ? (
        <p className="text-center text-red-400">Failed to load testimonials.</p>
      ) : (
