      ...
      <div className="bg-white dark:bg-[#121214] rounded-2xl w-full max-w-2xl shadow-2xl flex flex-col overflow-hidden border border-white/10">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/5">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setScale(s => Math.max(0.5, s - 0.1))} className="p-1.5 hover:bg-gray-100 rounded-md transition-colors text-black dark:text-white"><ZoomOut size={16} /></button>
            <span className="text-xs font-bold w-10 text-center text-black dark:text-white">{Math.round(scale * 100)}%</span>
            <button onClick={() => setScale(s => Math.min(1.5, s + 0.1))} className="p-1.5 hover:bg-gray-100 rounded-md transition-colors text-black dark:text-white"><ZoomIn size={16} /></button>
        ...
        <div className="flex-1 overflow-auto bg-gray-100 dark:bg-black p-10 flex justify-center items-start">
          <div className="flex flex-col md:flex-row gap-6 p-4 bg-transparent" style={{ transform: `scale(${scale})`, transformOrigin: "top center" }}>
            ...
            {/* Front Part */}
            <div className="w-[54mm] h-[86mm] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.15)] relative overflow-hidden shrink-0 flex flex-col font-sans text-black border border-gray-100 rounded-[2px]">
            ...
            {/* Back Part */}
            <div className="w-[54mm] h-[86mm] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.15)] relative overflow-hidden shrink-0 p-[4mm] flex flex-col items-center text-center font-sans text-black border border-gray-100 rounded-[2px]">
              <p className="text-[8pt] font-black text-gray-900 mb-[1mm] uppercase tracking-[0.2px]">Terms and conditions</p>
              ...
              <div className="mb-[2.5mm] flex flex-col items-center">
                <div className="text-[#c1121f] font-black text-[6.5pt] uppercase leading-tight tracking-[0.1px]">Bangladesh Technical</div>
                <div className="text-[#003049] font-bold text-[6pt] uppercase tracking-[0.1px] mt-[0.5px]">Education Technology</div>
              </div>

              <div className="w-[20mm] h-[20mm] border border-gray-200 rounded-[4px] p-[1.5mm] mb-[2mm] bg-white flex items-center justify-center shadow-sm">
              ...
              <p className="text-[#c1121f] font-black text-[8pt] uppercase tracking-[0.2px] mb-[0.5px]">Office Address</p>
              ...
              <div className="text-[5.2pt] font-bold leading-normal text-gray-700 max-w-[45mm] line-clamp-3">
                {student.officeAddress ? (
                  ...
                  <>Gawsia, Bhulta, Rupganj, Narayanganj<br/>Dhaka, Bangladesh</>
                )}
              </div>
